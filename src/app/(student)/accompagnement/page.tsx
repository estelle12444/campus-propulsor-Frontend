...
import CampusFranceGuide from '../CampusFranceGuide/page';
import ScholarshipFinder from '../ScholarshipFinder/page';
import CVLetterGenerator from '../CVLetterGenerator/page';
